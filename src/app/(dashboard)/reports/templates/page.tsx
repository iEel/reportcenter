...
import { Search, Filter, Copy, Download, LayoutTemplate, ChevronDown, CheckCircle2, RefreshCw, Loader2, AlertCircle, Star, Tag, BarChart3, Calendar, Play, ArrowRight } from "lucide-react";
                    ...
                    {isExecuting ? (
                        ...
                        <div className="h-full flex items-center justify-center p-8">
                            <div className="text-center max-w-lg space-y-6">
                                {/* Icon */}
                                <div className="w-20 h-20 bg-gradient-to-br from-purple-100 to-fuchsia-100 dark:from-purple-900/30 dark:to-fuchsia-900/30 rounded-3xl flex items-center justify-center mx-auto shadow-sm">
                                    <LayoutTemplate className="w-10 h-10 text-purple-500 dark:text-purple-400" />
                                </div>
                                ...
                                <div className="flex items-center justify-center gap-3">
                                    <div className="flex flex-col items-center gap-2 px-4 py-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-100 dark:border-purple-800">
                                        <div className="w-8 h-8 bg-purple-500 text-white rounded-lg flex items-center justify-center text-sm font-bold">1</div>
                                        <LayoutTemplate className="w-5 h-5 text-purple-500" />
                                        <span className="text-xs font-medium text-purple-700 dark:text-purple-300">เลือกรายงาน</span>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center gap-2 px-4 py-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                                        <div className="w-8 h-8 bg-blue-500 text-white rounded-lg flex items-center justify-center text-sm font-bold">2</div>
                                        <Calendar className="w-5 h-5 text-blue-500" />
                                        <span className="text-xs font-medium text-blue-700 dark:text-blue-300">กรอก Parameter</span>
                                    </div>
                                    <ArrowRight className="w-4 h-4 text-slate-300 dark:text-slate-600 flex-shrink-0" />
