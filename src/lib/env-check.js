...
const REQUIRED = [
    ...
    'DB_DATABASE',
    'JWT_SECRET',
    'C1_DB_USER', 'C1_DB_PASSWORD', 'C1_DB_SERVER', 'C1_DB_DATABASE',
    'C2_DB_USER', 'C2_DB_PASSWORD', 'C2_DB_SERVER', 'C2_DB_DATABASE',
    'C3_DB_USER', 'C3_DB_PASSWORD', 'C3_DB_SERVER', 'C3_DB_DATABASE',
    'CRON_SECRET',
];
